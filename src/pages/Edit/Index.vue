...
const postCat = {
  ...
  array:
    "https://cdn-cos.luoyangfu.com/2018-07-31/cate/JavaScript-Array-logo.png",
...
export default {
  ...
  methods: {
    ...
    handleCategories(cates) {
      this.categories = cates.map(c => ({ catName: c.name, catImg: c.img }));
    },
      ...
      if (this.post && this.postTitle) {
        const cateFlag =
          this.postTitle.indexOf("array") !== -1
            ? "array"
            : this.postTitle.indexOf("webpack") !== -1
            ? "webpack"
            : "js";
